...
export const DictByd: FC<ViewPorps<BydResult>> = ({ result }) => {
  return renderByd(result)
  // switch (result.type) {
  //   case 'lex':
  //     return renderLexByd(result)
  //   case 'machine':
  //     return renderMachineByd(result)
  //   case 'related':
  //     return renderRelatedByd(result)
  //   default:
  //     return null
  // }
}

export default DictByd

function renderByd(result: BydResult) {
  return (
    <>
      <div>{result.originText}</div>
...
function renderMachineByd(result: BingResultMachine) {
  return (
    <>
      <p>renderMachineByd</p>
    </>
  )
}
...
function renderRelatedByd(result: BingResultRelated) {
  return (
    <>
      <div>renderRelatedByd</div>
    </>
  )
}
